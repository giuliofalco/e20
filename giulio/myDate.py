...
class MyDate():
    ...
    def data_wday(self,week,day):
      # calcola la data corrispondente alla settimana specificate e al giorno (0..6)
      # quanti giorni sono passati dal primo lunedi dell'anno (iso) trascorse week settimane e aggiunto day
