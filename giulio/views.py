...
from giulio.models import Diario, Consumazione, Alimento
...
def index(request):
   ...
   return render(request, 'giulio/index.html', context)
...
def settimana(request,w):
      ...
      return render(request,'giulio/settimana.html',context)
...
def modifica(request,id,week,pasto,day): 
     ...
     return render(request,'giulio/modifica.html',context)
...
# registra la modifica effettuata aggiungendo un alimento al pasto della settimana 
    ...
    return HttpResponseRedirect(reverse('giulio:modifica',args=(miodiario.id,settimana,strpasto,giorno,)))
...
# inserisce un nuovo oggetto evento del giorno nel diario nel sistema
    ...
    return HttpResponseRedirect(reverse('giulio:index'))
...
def cancella(request,idGiorno,pasto,al,week,day):
   ...
   # e il nome alimento. Lo cancella dalla lista della consumazione
    ...
    return HttpResponseRedirect(reverse('giulio:modifica',args = (idGiorno,week,config.PASTIL[pasto],day))) # reindirizzo a index
